...
Registers only the v0.1 commands (``init``, ``ingest``, ``config``). Future
command modules (``review``, ``lint``, ``merge``, ``collab``, ``serve``,
``chat``, ``fusion``) exist as scaffolding but are intentionally not wired up.
"""
