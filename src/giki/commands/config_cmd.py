...
def tips() -> None:
    ...
    print_panel(
        ...
        "  [bold]pricing.<model-prefix>[/bold]    [input, output] USD per 1M tokens;\n"
        "                                  overrides the built-in pricing table.\n"
        "                                  First hit wins — declare longer prefixes first.\n"
        "                                  (edit config.yaml directly; `config set` can't write lists)\n\n"
        "Full reference:\n"
